...
public class DatarFrameJdbcApp {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		scala.tools.scalap.Properties.setProp("password", "root");
		
		log.info("=====================================>>>>>>>>>>>>>>> Total: {}", sqlContext.read().jdbc(JdbcUtil.MYSQL_CONNECTION_URL,  "book_file", props));
	
		Map<String, String> options = new HashMap<String, String>();
		options.put("driver", JdbcUtil.MYSQL_DRIVER_CLASS);
		options.put("url", JdbcUtil.MYSQL_CONNECTION_URL);
		options.put("dbtable", "book_file");
